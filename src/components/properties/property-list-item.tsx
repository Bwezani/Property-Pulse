        ...
        <div className="flex justify-between items-start gap-2">
          ...
          <div className="flex flex-col gap-1.5 items-end shrink-0">
            ...
            {property.units && property.units > 1 && (
              <Badge
                variant="secondary"
                className="bg-muted/50 text-muted-foreground flex items-center gap-1.5 text-[10px] py-1 h-7 rounded-lg px-2.5 border-none"
              >
        ...
        <div className="space-y-2.5">
          ...
          <CardTitle className="font-headline text-2xl line-clamp-1 leading-tight tracking-tight">
            <Link
              ...
              className="hover:text-primary transition-colors flex items-center justify-between group/title"
            >
              {property.name}
          ...
          <TooltipProvider>
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span
                  className={cn(
                    "font-bold text-sm font-headline",
              ...
              <div className="grid grid-cols-2 gap-4 text-[10px] pt-1">
                <div className="space-y-1">
                  <p className="text-muted-foreground uppercase tracking-widest font-bold opacity-60">
                    Actual Spent
                  </p>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <p
                        className={cn(
                          "font-bold text-sm cursor-help tracking-tight",
                    ...
                    <TooltipContent
                      side="bottom"
                      className="font-mono text-[10px] bg-popover border-border shadow-xl"
                    >
