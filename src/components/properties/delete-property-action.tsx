    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This will permanently delete <strong>{property.name}</strong> from
            your profile. Make sure you don't need its historical data as this
            cannot be undone. Associated expenses and income logs will remain in
            the database but will no longer be visible under this property.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
