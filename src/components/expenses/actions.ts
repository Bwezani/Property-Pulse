...
export async function addConstructionExpenseAction(
  ...
  const colRef = collection(db, "users", userId, "construction_expenses");
...
export async function addMaintenanceExpenseAction(
  ...
  const colRef = collection(db, "users", userId, "maintenance_expenses");
...
export async function addConstructionBudgetItemAction(
  ...
  const colRef = collection(db, "users", userId, "construction_budget_items");
...
export async function addMaintenanceBudgetItemAction(
  ...
  const colRef = collection(db, "users", userId, "maintenance_budget_items");
...
export async function updateMaintenanceBudgetActualCostAction(
  ...
  const ref = doc(db, "users", userId, "maintenance_budget_items", itemId);
...
export async function deleteConstructionExpenseAction(
  ...
  const docRef = doc(db, "users", userId, "construction_expenses", expenseId);
...
export async function deleteMaintenanceExpenseAction(
  ...
  const docRef = doc(db, "users", userId, "maintenance_expenses", expenseId);
...
export async function deleteMaintenanceBudgetItemAction(
  ...
  const docRef = doc(db, "users", userId, "maintenance_budget_items", itemId);
